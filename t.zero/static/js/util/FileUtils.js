class FileUtils {
    ...
    static CONTENT_EXCEL = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
     ...
     *
     */
    static chooseFileToRead(callback, option) {
     ...
     */
    static chooseFileArrayToRead(callback, {binary, includeFile}) {
        if (!callback) {
    ...
    static chooseFileToSave(content, fileName, contentType) {
