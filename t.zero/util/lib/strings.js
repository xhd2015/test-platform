...
exports.decodeArrayToString = decodeArrayToString;
...
exports.possibleNumberOf = possibleNumberOf;
exports.quoteToCString = quoteToCString;
exports.toInt8ArrayJSON = toInt8ArrayJSON;
...
function possibleNumberOf(s) {
  let n = Number(s);
  return isNaN(n) ? s : n;
}

function decodeArrayToString(arrayBuffer) {
  // Decode as UTF-8
...
function encodeToHexString(byteArray) {
  if (byteArray == null) {
    return "";
  }
...
function quoteToCString(arrayBuffer) {
...
function toInt8ArrayJSON(arrayBuffer) {
