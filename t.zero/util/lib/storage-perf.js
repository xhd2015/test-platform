...
exports.PerfV1_2 = exports.PerfV1_1 = exports.Perf = exports.IDGen = void 0;

var objpath = _interopRequireWildcard(require("@fultonjs/common/lib/objpath"));
...
class Perf {
  ...
  async _set(table, key, value, head) {
    ...
    const idx = keys.indexOf(key); // head or tail, idx===0 always not need to insert
